...
class ReadingArticlePage extends Component {
  constructor(props) {
    super(props);
    this.state = {};
  }
        ...
        <div className="article-container">
          <div className="article-title-container">
            <h2 className="article-title">
              Why Now is the best time in history to start a robotic start up
            </h2>
          </div>
          ...
          <div className="article-image-container">
            <img
              src="https://res.cloudinary.com/sojidan/image/upload/v1557855957/eg5ki8dgo7nlucvo4sf8.jpg"
              alt="header"
            />
          </div>
